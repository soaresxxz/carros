...
export default function App (){
  return (
    <main className="min-h-svh bg-offwhitebg  py-28 px-6 antialiased  lg:flex justify-center items-center">
      <section className="lg:flex max-w-[920px]">
        <div className="bg-orange p-12 max-lg:rounded-t-lg lg:rounded-l-lg">
          ...
          <a className="font-lexend bg-offwhitebg px-10 py-3 w-fit rounded-3xl text-orange border-2 border-offwhitebg hover:bg-orange hover:text-offwhitebg" href="https://www.webmotors.com.br/carros/estoque" target="_blank">Ver mais</a>
        </div>
      <div className="bg-green p-12 ">
        ...
        <a className="font-lexend  bg-offwhitebg px-10 py-3 w-fit rounded-3xl text-green border-2 border-offwhitebg hover:bg-green hover:text-offwhitebg" href="https://www.webmotors.com.br/carros/estoque" target="_blank">Ver mais</a>
      </div>

      <div className="bg-dark-green p-12 max-lg:rounded-b-lg lg:rounded-r-lg">
        <img src={iconLuxury} alt="" className="mb-7"/>
        <h2 className="font-shoulders mb-7 uppercase text-4xl fold-bold text-offwhitebg">Luxurys</h2>
        ...
        <a className="font-lexend  bg-offwhitebg px-10 py-3 w-fit rounded-3xl text-dark-green border-2 border-offwhitebg hover:bg-dark-green hover:text-offwhitebg" href="https://www.webmotors.com.br/carros/estoque" target="_blank">Ver mais</a>
