    ...
    <main className="min-h-svh bg-offwhitebg  py-28 px-6 antialiased  lg:flex justify-center items-center">
      <section className="lg:flex">
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <a className="font-lexend bg-offwhitebg px-10 py-3 w-fit rounded-3xl text-orange" href="https://www.webmotors.com.br/carros/estoque" target="_blank">Ver mais</a>
        </div>
      <div className="bg-green p-12 ">
        ...
        <a className="font-lexend  bg-offwhitebg px-10 py-3 w-fit rounded-3xl text-green" href="https://www.webmotors.com.br/carros/estoque" target="_blank">Ver mais</a>
      </div>
